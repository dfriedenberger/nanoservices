...
class JobRepository:
    ...
    def __init__(self):
        ...
        self.table_job = Table("job",['id', 'job', 'state'],['VARCHAR(36)', 'JSON', 'VARCHAR(100)'])
    
    def create_job(self,obj): 
        self.table_job.create(obj)

    def read_job(self,id):
        return self.table_job.read_by_id(id)

    def update_job(self,obj):
        self.table_job.update_by_id(obj)
    
    def delete_job(self,id):
        self.table_job.delete_by_id(id)
