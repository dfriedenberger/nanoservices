...
from .graphwrapper import GraphWrapper, create_ref


def create_rdf_graph_from_yaml(text : str) -> Graph:
    """
    Create rdf graph from given yaml definition.

    :param text: yaml definition as String
    :return: rdf graph
    """
    try:
